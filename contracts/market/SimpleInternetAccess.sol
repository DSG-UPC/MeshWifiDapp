...
contract SimpleInternetAccess is Ownable, usingOracle{
    ...
    constructor(address _client, string _providerIP, string _providerMonitor,
      uint _maxData, address creator, address _DAOAddress,
     ...
     */
    function acceptContract(string _clientMonitor, bytes32 _pubKey, uint256 _value)
      public
      returns (bool success)
    {
        ...
        require(client.wallet == msg.sender && tokenContract.allowance(msg.sender,address(this)) >= maxData*pricePerMB);
        if (tokenContract.transferFrom(msg.sender,address(this),_value)){
    ...
    function provideTicket(string newTicket)
      public
      returns (bool success)
    {
    ...
    function checkUsage() public {
        ...
        queryOracle('monitor', msg.sender, provider.monitor);
